	...
	v-form(ref='form', v-model='valid')
		...
		v-dialog(v-model='dialog', persistent, max-width='340')
			v-card
				...
				v-card-actions
					v-btn(color='red darken-1', flat, @click="deleteCertificate", :disabled="isLoading", :loading="isLoading") Удалить
					v-spacer
					v-btn(color='green darken-1', flat, @click="dialog = false", :disabled="isLoading", :loading="isLoading") Не удалять
</template>
